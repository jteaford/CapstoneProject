...
insert into wood_types (type_of_wood, thickness_of_wood, variety) values ('White Oak', '4/4', 'Rift');
insert into wood_types (type_of_wood, thickness_of_wood) values ('Maple Hard 1,2 White', '8/4');
insert into wood_types (type_of_wood, thickness_of_wood, variety) values ('White Oak', '4/4', 'Quarter-Sawn');
insert into wood_types (type_of_wood, variety, thickness_of_wood) values ('Birch SW A1', 'Plywood', '1/4');
insert into wood_types (type_of_wood, thickness_of_wood, variety) values ('White Oak', '8/4', 'Quarter-Sawn');
insert into wood_types () values ();
insert into wood_types () values ();
insert into wood_types () values ();
insert into wood_types () values ();
...
insert into wood_prices (price_per_unit, unit_type, location_id) values (2, 3.90, 'BF', 3);
insert into wood_prices (price_per_unit, unit_type, location_id) values (3, 5.90, 'BF', 3);
insert into wood_prices (price_per_unit, unit_type, location_id) values (4, 58.82, 'Sheet', 3);
insert into wood_prices (price_per_unit, unit_type, location_id) values (5, 9.3984, 'BF', 3);
insert into wood_prices (type_of_wood, thickness_of_wood, price_per_unit, unit_type, location_id) values ('White Oak F1F', '5/4', 4.75, 'BF', 3);
insert into wood_prices (type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('Maple', 'Plywood', '1/2', 26.98, 'Sheet', 1);
insert into wood_prices (size, type_of_wood, thickness_of_wood, price_per_unit, unit_type, location_id) values ('6x10', 'Poplar Board', '3/4', 28.30, 'Board', 1);
insert into wood_prices (type_of_wood, thickness_of_wood, price_per_unit, unit_type, location_id) values ('White Oak F1F', '5/4', 4.75, 'BF', 1);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('4x8', 'Sanded', 'Plywood', '1/4', 22.92, 'Sheet', 4);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('4x8', 'Sanded', 'Plywood', '1/2', 35.95, 'Sheet', 4);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('4x8', 'MDF', 'Panel', '1/2', 20.96, 'Sheet', 4);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('4x8', 'Birch', 'Plywood', '3/4', 55.98, 'Sheet', 4);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('25''', 'WH Birch', 'Plywood', '3/4', 6.58, 'Board', 1);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('4x8', 'Top Choice Birch', 'Plywood', '3/4', 55.98, 'Sheet', 1);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('4x12', 'Top Choice KD Fir', 'Board', '6/4', 5.64, 'Board', 1);
insert into wood_prices (size, type_of_wood, variety, thickness_of_wood, price_per_unit, unit_type, location_id) values ('6x12', 'Top Choice KD Fir', 'Board', '6/4', 8.46, 'Board', 1);
