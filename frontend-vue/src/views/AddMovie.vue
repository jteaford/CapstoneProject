<template>
    <div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input id="releaseDate" class="input" type="date" v-model="movie.releaseDate" placeholder="Release Date"/>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">   
                <input id="trailerUrl" class="input" type="text" v-model="movie.trailerUrl" placeholder="Trailer Url" />
            </div>
        </div>
